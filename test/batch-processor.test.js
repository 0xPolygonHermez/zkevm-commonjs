...
const {
    ...
    Constants, stateUtils, txUtils, batchUtils,
} = require('../index');
...
const { ENUM_TX_TYPES } = require('../src/compression/compressor-constants');
...
describe('Processor', async function () {
    ...
    it('Check test vectors', async () => {
        for (let i = 0; i < 1; i++) {
            ...
            // Add txs to the batch processor
